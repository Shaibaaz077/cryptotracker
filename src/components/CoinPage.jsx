...
const CoinPage = () => {
      ...
      useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (!detailsRes.ok) throw new Error(`Failed to fetch coin details : ${detailsRes.statusText}`);
                ...
                if (!chartRes.ok)  throw new Error(`Failed to fetch chart data: ${chartRes.statusText}`);
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-gray-900 via-gray-900/95 to-gray-900/90 text-white
     px-4 sm:px-[5%] md:px-[8%] py-6  '>
        <div className='flex flex-col items-center md:flex-row gap-4 mb-4 bg-gray-800/30 backdrop-blur-lg p-4 rounded-xl
        border border-emerald-500/20'>
         ...
         <div className='flex flex-col sm:flex-row items-start justify-between sm:items-center mb-3 gap-2'>
         ...
         <div className='space-y-3 md:hidden'>
            ...
            <div className='flex justify-between items-center'>
                <span className='text-sm text-cyan-400/80'>24 High </span>
            ...
            <div className='space-y-3'>
            <div className='flex justify-between items-center'>
                <span className='text-sm text-cyan-400/80'>24 Low</span>
                <div className='flex items-center text-green-400'>
