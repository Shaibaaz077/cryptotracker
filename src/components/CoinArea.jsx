    ...
    {/* HERO SECTION */}
        ...
        <div className=' text-center mb-8 md:mb-12 space-y-4 group relative'>
               <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-emerald-400
                via-cyan-400 to-emerald-400 bg-clip-text text-transparent animate-gradient-x leading-tight'>
                Crypto <br />
               ...
               <p className='text-gray-300/80 max-w-xl mx-auto text-sm sm:text-base md:lg leading-relaxed
               mt-4 '>
                Track real-time crypto market metricrs with advance analytics advance and <br />
        ...
        border border-emerald-500/20'>
           ...
           <p className='text-cyan-400/90'>Coin</p>
        ...
        {isCurrencyDropdownOpen && (
            <div className=' relative bg-gray-800/95 border border-emerald-500/0 rounded-lg shadow-2xl
            backdrop-blur-xl z-50'>
            {["usd", "eur", "inr"].map((code) => {
                return (
                    <div key={code} className='px-4 py-3 hover:bg-emerald-600/30 cursor-pointer transition-colors 
        ...
        {filteredcryptos.slice(0, 12).map((item) => (
                ...
                border border-emerald-500/10 hover:border-cyan-500/30 transition-all duration-300 group' >
                    <div className='md:hidden space-y-3'>
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center gap-3'>
                                ...
                                <img src={item.image} alt={item.name} className='w-7 h7 sm:w-8 sm:h-8 rounded-full
                                ...
                                <div>
                                    ...
                                    <p className='text-xs sm:sm text-cyan-400/80 mt-0.5'>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 p-0.5' />

                        <div className='font-medium text-gray-100 text-base lg:text-lg'>
                            <p>
                                {item.name}
                            </p>
                            <p className='text-xs lg:text-sm text-cyan-400/80 mt-0.5'>{item.symbol.toUpperCase()}</p>
                        </div>
                    </div>
